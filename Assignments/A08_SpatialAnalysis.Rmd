...
UScounty <- st_read("./Data/Spatial/cb_2018_us_county_20m.shp")
...
>ANSWER: 
> The "dec_long_va" and "dec_lat_va" are replaced by a new field "geometry", which contains the long, lat data 
of objects.
...
flow <- read.csv("./Data/Raw/NWIS_SiteFlowData_NE_RAW.csv", header = T, colClasses = c('site_no' = 'character'))
